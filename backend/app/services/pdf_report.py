...
<div style="display:flex;justify-content:space-between;align-items:center;padding-bottom:24px;border-bottom:2px solid #c87941;margin-bottom:32px;">
  <div style="display:flex;align-items:center;gap:10px;">
    <div style="width:36px;height:36px;border-radius:8px;background:linear-gradient(135deg,#c87941,#8b5a2b);display:flex;align-items:center;justify-content:center;color:white;font-weight:700;font-size:12px;font-family:Georgia,serif;">OR</div>
    <div>
      <div style="font-family:Georgia,serif;font-size:20px;">Omni-Rank</div>
      <div style="font-size:10px;text-transform:uppercase;letter-spacing:0.15em;color:#888;">SEO Intelligence Report</div>
    </div>
  </div>
...
<p style="font-size:14px;color:#888;margin-bottom:6px;">Target: <strong style="color:#c87941;">{client_url}</strong> · Keyword: <strong>"{keyword}"</strong></p>
{meta_badge}
...
<div style="padding-top:24px;border-top:1px solid #e8e0d4;display:flex;justify-content:space-between;font-size:11px;color:#888;">
  <div>Generated by Omni-Rank · {now}</div>
  <div>Confidential — {project_name or client_url}</div>
</div>

<div class="no-print" style="text-align:center;margin-top:24px;">
  <button onclick="window.print()" style="padding:12px 32px;border-radius:8px;background:linear-gradient(135deg,#c87941,#8b5a2b);color:white;border:none;cursor:pointer;font-size:14px;">
    Download as PDF
  </button>
