    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-surface-1">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-1">Log in to your OMNI-RANK account</p>
        </div>

        <button onClick={handleGoogleLogin} className="btn-secondary w-full flex items-center justify-center gap-2 mb-6">
        ...
        <p className="text-center text-sm text-zinc-400 mt-6">
          Don&apos;t have an account? <Link href="/auth/signup" className="text-brand-400 hover:text-brand-300">Sign up</Link>
        </p>
      </div>
    </div>
  );
