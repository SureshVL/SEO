...
import { BarChart3, Bot, ClipboardList, Eye, FileText, Home, LayoutDashboard, LogOut, Search, Settings, Shield, Zap } from "lucide-react";
...
const navSections = [
  ...
  { label: "Intelligence", items: [{ href: "/dashboard/research", label: "AI Research", icon: Bot },{ href: "/dashboard/keywords", label: "Keywords", icon: Search },{ href: "/dashboard/rank-tracker", label: "Rank Tracker", icon: BarChart3 },{ href: "/dashboard/competitors", label: "Competitors", icon: Eye }]},
  { label: "Execute", items: [{ href: "/dashboard/audit", label: "Technical Audit", icon: Shield },{ href: "/dashboard/content", label: "Content Studio", icon: FileText },{ href: "/dashboard/reports", label: "Reports", icon: ClipboardList }]},
