...
import { BarChart3, Bot, Braces, ClipboardList, Coins, Eye, FileText, Home, LayoutDashboard, Lightbulb, LogOut, Search, Settings, Shield, Sparkles, Zap } from "lucide-react";
