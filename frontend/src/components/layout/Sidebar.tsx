...
import { BarChart3, Bot, Braces, ClipboardList, Coins, Eye, FileText, Grid3x3, Home, LayoutDashboard, Lightbulb, Link2, LogOut, Palette, Search, Settings, Shield, Sparkles, Zap } from "lucide-react";
