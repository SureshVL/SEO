...
import { BarChart3, Bot, Braces, ClipboardList, Eye, FileText, Home, LayoutDashboard, LogOut, Search, Settings, Shield, Sparkles, Zap } from "lucide-react";
...
const navSections = [
  ...
  { label: "Execute", items: [{ href: "/dashboard/audit", label: "Technical Audit", icon: Shield },{ href: "/dashboard/schema", label: "Schema Markup", icon: Braces },{ href: "/dashboard/content", label: "Content Studio", icon: FileText },{ href: "/dashboard/reports", label: "Reports", icon: ClipboardList }]},
